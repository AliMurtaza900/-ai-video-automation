...
The character name is normalized to lowercase with spaces/punctuation replaced by underscores. For example, `Milo The Brave` becomes `assets/character_references/milo_the_brave/`.
